...
{
    public class DbInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<ApplicationDbContext>//DropCreateDatabaseAlways<ApplicationDbContext>//
    {
        ...
        private void Register(RegisterViewModel model, ApplicationDbContext context, IdentityRole role, Department department)
        {
            ...
            if (!context.Users.Any(u => u.UserName == "admin@admin.net"))
            {
                var user = new ApplicationUser
                {
                    ...
                    PasswordHash = PasswordHash.HashPassword("adminpass")
                };
                ...
                //Assign Role to user
                UserManager.AddToRoleAsync(updateId, department.DepartmentName);
            }
        }
