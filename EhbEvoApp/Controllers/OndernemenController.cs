...
{
    public class OndernemenController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var posts = db.Posts.Where(p => p.PostCategory == PostCategory.Ondernemen && p.UserId == currentUserId);
        ...
        public ActionResult Create([Bind(Include = "Id,Evopoints,UserId,PostType,PostCategory,Title,Content,ImgUrl,Date")] Post post)
        {
            if (ModelState.IsValid)
            {
                ...
                if(post.ImgUrl == null)
                {
                    ...
                    {
                        case PostType.Idee:
                            post.ImgUrl = Url.Content("~/Content/images/ondernemenidee.png");
                            break;
                        case PostType.Plan:
                            post.ImgUrl = Url.Content("~/Content/images/ondernemenplan.png");
                            break;
                        case PostType.Actie:
                            post.ImgUrl = Url.Content("~/Content/images/ondernemenactie.png");
                            break;
                        default:
                            break;
                    }
