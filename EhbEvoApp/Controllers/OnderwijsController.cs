...
namespace EhbEvoApp.Controllers
{
    public class OnderwijsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var posts = db.Posts.Where(p => p.PostCategory == PostCategory.Onderwijs && p.UserId == currentUserId);
        ...
        public ActionResult Create([Bind(Include = "Id,Evopoints,UserId,PostType,PostCategory,Title,Content,ImgUrl,Date")] Post post)
        {
            if (ModelState.IsValid)
            {
                ...
                if(post.ImgUrl == null)
                {
                    ...
                    {
                        case PostType.Idee:
                            post.ImgUrl = Url.Content("~/Content/images/Onderwijsidee.png");
                            break;
                        case PostType.Plan:
                            post.ImgUrl = Url.Content("~/Content/images/onderwijsplan.png");
                            break;
                        case PostType.Actie:
                            post.ImgUrl = Url.Content("~/Content/images/Onderwijsactie.png");
                            break;
                        default:
                            break;
                    }
